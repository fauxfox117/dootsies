        ...
        <div className="about-hero-pin">
          <div className="hero-heading">
            <Copy animateOnScroll={false} delay={0.85}>
              <h1 className="heading-line-1">Dootsie's</h1>
      ...
      <section className="about-info">
        <div className="container">
          <Copy>
            ...
            <h3>
              Dootsie's is an exercise in quiet composition, where space, light,
              and material come together with deliberate restraint.
            </h3>
            <h3>
